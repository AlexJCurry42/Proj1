...
export function initAboutModal() {
  ...
  document.getElementById('about-content').innerHTML = `
    ...
    <h3>Privacy</h3>
    <p><strong>No tracking, ever.</strong> No analytics, no cookies, no accounts. Preferences (layers, night-vision mode) live only in your browser's local storage. The Sky&nbsp;Now feature reads your location and motion sensors on this device solely to compute and track what's overhead — nothing is ever transmitted anywhere. One exception, on your explicit action only: a certain Easter egg embeds YouTube's privacy-enhanced player at the moment you trigger it (nothing from YouTube loads until then, and ✕ removes it).</p>
    <h3>Open source</h3>
